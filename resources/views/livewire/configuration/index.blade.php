    ...
    Export Data
                        ...
                        <div class="w-full md:w-1/3">
                            <div class="relative">
                                ...
                                <input type="text" id="Search" placeholder="Search configuration..." class="w-full rounded-md border-gray-200 focus:border-gray-800 py-2.5 pe-10 shadow-sm sm:text-sm" />
