            ...
            <div class="w-full md:w-1/4 px-4">
                <div class="bg-white dark:bg-gray-800 overflow-hidden sm:rounded-lg px-6 py-4 shadow sm:rounded-tl-md sm:rounded-tr-md">
                    <div class="py-4 px-2 mt-2 flex">
                        ...
                        <b class="text-lg">{{ __('Device\'s Incident') }}</b>
                    </div>
                    <div class="px-2 mb-8">
                        <fieldset>
                            <div class="space-y-2">
    ...
    Export Data
                        ...
                        <div class="w-full md:w-1/3">
                            <div class="relative">
                                ...
                                <input type="text" id="Search" placeholder="Search report..." class="w-full rounded-md border-gray-200 focus:border-gray-800 py-2.5 pe-10 shadow-sm sm:text-sm" />
                            ...
                            <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
                                <thead class="text-left">
                                    <tr>
                                        ...
                                        <th class="whitespace-nowrap px-4 py-2 font-bold text-gray-900">Reported At</th>
